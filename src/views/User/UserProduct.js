...
const CompanyTr = ({ company }) => {
  return (
    <tr>
      <td>
        <div className="img-container">
          <img alt="..." src={require("assets/img/blog-1.jpg")}></img>
        </div>
      </td>
      ...
      <td className="td-actions">
        <OverlayTrigger
          ...
          placement="left"
        >
          <Button className="btn-link btn-icon" type="button" variant="info">
        ...
        <OverlayTrigger
          ...
          placement="left"
        >
          <Button className="btn-link btn-icon" type="button" variant="success">
            <i className="fas fa-edit"></i>
          </Button>
        </OverlayTrigger>
        <OverlayTrigger
          overlay={<Tooltip id="tooltip-408856985">Remove Post..</Tooltip>}
          placement="left"
        >
          <Button className="btn-link btn-icon" type="button" variant="danger">
    ...
    <Col md="6">
      ...
      <div id="badge">
        ...
        <TagsInput
          ...
          tagProps={{
            className: "react-tagsinput-tag tag-fill tag-green",
          }}
        />
      </div>
    </Col>
